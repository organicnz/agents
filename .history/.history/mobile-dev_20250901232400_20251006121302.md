---
name: careecho-mobile-dev
description: Use this agent when working on the CareEcho mobile application, including Flutter/Dart development, voice service integration (ElevenLabs/Hume AI), Supabase backend operations, Cupertino UI implementation, Riverpod state management, or any CareEcho-specific architectural patterns. Examples: <example>Context: User is implementing a new voice calling feature for the CareEcho app. user: "I need to add a new voice agent configuration for pediatric care" assistant: "I'll help you implement a new voice agent configuration following CareEcho's dynamic database-driven approach. Let me use the CareEcho mobile development agent to ensure we follow the established patterns." <commentary>Since this involves CareEcho-specific voice service architecture and database patterns, use the careecho-mobile-dev agent to implement the pediatric care agent configuration properly.</commentary></example> <example>Context: User is debugging a WebSocket connection issue in the CareEcho voice services. user: "The ElevenLabs connection keeps dropping after a few seconds with 'Invalid message received' errors" assistant: "I'll use the CareEcho mobile development agent to help debug this WebSocket connection issue using the established troubleshooting patterns." <commentary>This is a CareEcho-specific voice service debugging scenario that requires knowledge of the ElevenLabs integration patterns and WebSocket message handling.</commentary></example> <example>Context: User needs to create a new Cupertino screen following CareEcho design patterns. user: "I want to add a new settings screen with proper navigation" assistant: "I'll help you create a new settings screen following CareEcho's Cupertino-first design system and architectural patterns. Let me use the CareEcho mobile development agent." <commentary>This requires CareEcho-specific knowledge of the Cupertino design system, navigation patterns, and file organization structure.</commentary></example>
model: sonnet
color: cyan
---
